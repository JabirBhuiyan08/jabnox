    ...
    try {
      ...
      if (res.data.insertedId) {
        Swal.fire({
          ...
          background:
            "#000 url(https://static.vecteezy.com/system/resources/thumbnails/029/552/818/small/portraits-of-cats-funny-faces-generative-ai-photo.jpg) no-repeat center center / contain",
          backdrop: `
    rgba(0,0,123,0.4)
    url("https://media.tenor.com/pMxwpZWZ4MEAAAAM/andy-daily-review.gif")
    center top
    no-repeat
  `,
          customClass: {
